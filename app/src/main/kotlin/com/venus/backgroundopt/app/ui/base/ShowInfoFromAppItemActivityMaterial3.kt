...
import com.venus.backgroundopt.app.utils.getIntentData
...
abstract class ShowInfoFromAppItemActivityMaterial3 : BaseActivityMaterial3() {
    ...
    protected open fun init() {
        ...
        val list = JSON.parseArray(stringExtra, ProcessRecordBaseInfo::class.java)
        list ?: return
    ...
    protected open fun initRecyclerView(appItems: MutableList<AppItem>, vararg others: Any?) {
        runOnUiThread {
            findViewById<RecyclerView>(getRecyclerViewResId()).apply {
                layoutManager =
                    LinearLayoutManager(this@ShowInfoFromAppItemActivityMaterial3).apply {
