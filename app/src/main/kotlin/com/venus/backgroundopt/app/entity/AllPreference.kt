...
package com.venus.backgroundopt.app.entity
...
import com.venus.backgroundopt.common.util.concurrent.newThreadTaskResult
        ...
        activity.registerForActivityResult(ActivityResultContracts.CreateDocument("application/json")) { uri ->
            ...
            newThreadTaskResult {
                activity.contentResolver.openOutputStream(uri).use { outputStream ->
                    ...
                    val jsonPreference =
                        com.venus.backgroundopt.app.entity.AllPreference.JsonPreference()
                    ...
                    val jsonString = jsonPreference.toJsonString()
            ...
            newThreadTaskResult {
                activity.contentResolver.openInputStream(uri)
                    ?.reader(StandardCharsets.UTF_8).use { inputStream ->
                        ...
                        val allPreference = json.parseObject(com.venus.backgroundopt.app.entity.AllPreference.JsonPreference::class.java)
                        // 写入配置
                        val context = activity.baseContext
