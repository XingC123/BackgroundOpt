...
import com.venus.backgroundopt.ui.component.VenusPopupMenuButton
...
class RunningProcessesActivityMaterial3 : ShowInfoFromAppItemActivityMaterial3() {
    ...
    private val updateRunningProcessExecutor by lazy(LazyThreadSafetyMode.NONE) {
     ...
     *                                                                         *
     **************************************************************************/
    private val nullProcessList by lazy { arrayListOf<BaseProcessInfoKt>() }
    ...
    private fun getRunningProcesses(): MutableList<BaseProcessInfoKt> {
        return sendMessageAcceptList<BaseProcessInfoKt>(
            context = this,
