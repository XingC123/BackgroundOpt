...
public interface MethodConstants {
    ...
    String getOrCreateUserState = "getOrCreateUserState";
    String getRoleHolders = "getRoleHolders";
    ...
    String updateLowMemStateLocked = "updateLowMemStateLocked";
    ...
    String updateAppUidRecLocked = "updateAppUidRecLocked";
