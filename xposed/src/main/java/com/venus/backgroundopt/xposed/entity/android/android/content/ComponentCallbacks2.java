...
package com.venus.backgroundopt.xposed.entity.android.android.content;
...
public interface ComponentCallbacks2 {
     ...
     */
    @OriginalObjectField(objectClassPath = ClassConstants.ComponentCallbacks2, fieldName = "TRIM_MEMORY_BACKGROUND")
    public static final int TRIM_MEMORY_BACKGROUND = ComponentCallbacks2Constants.TRIM_MEMORY_BACKGROUND;
     ...
     * managed.
     */
    @OriginalObjectField(objectClassPath = ClassConstants.ComponentCallbacks2, fieldName = "TRIM_MEMORY_UI_HIDDEN")
    public static final int TRIM_MEMORY_UI_HIDDEN = ComponentCallbacks2Constants.TRIM_MEMORY_UI_HIDDEN;
...
//    void onTrimMemory(@TrimMemoryLevel int level);
    @OriginalMethod(classPath = ClassConstants.ComponentCallbacks2, methodName = "onTrimMemory")
