...
package com.venus.backgroundopt.xposed.hook.constants;
...
public interface FieldConstants {
    ...
    String setAdj = "setAdj";
    String mCurRawAdj = "mCurRawAdj";
    String lastStateTime = "lastStateTime";
    String completedAdjSeq = "completedAdjSeq";
    String mCached = "mCached";
    String mCurSchedGroup = "mCurSchedGroup";
    String setSchedGroup = "setSchedGroup";
    String empty = "empty";
