 ...
 * @date 2024/7/14
 */
class ProcessServiceRecordCompatSinceA12(
    originalInstance: Any,
) : ProcessServiceRecord(originalInstance) {
    companion object : IProcessServiceRecord {
        @JvmStatic
        @IEntityCompatMethod
        override fun numberOfRunningServices(@OriginalObject(classPath = ClassConstants.ProcessServiceRecord) instance: Any): Int {
        ...
        override fun modifyRawOomAdj(
            @OriginalObject(classPath = ClassConstants.ProcessServiceRecord) instance: Any,
            adj: Int,
        ): Int {
            return instance.callMethod<Int>(
