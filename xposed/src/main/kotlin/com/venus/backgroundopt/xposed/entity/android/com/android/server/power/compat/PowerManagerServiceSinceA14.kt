 ...
 * @date 2024/8/27
 */
class PowerManagerServiceSinceA14(
    ...
    companion object : IPowerManagerService {
        override fun isGloballyInteractiveInternal(@OriginalObject instance: Any): Boolean {
            return instance.callMethod<Boolean>(MethodConstants.isGloballyInteractiveInternal)
        }
        ...
        override fun isInteractiveInternal(
            ...
            return instance.callMethod<Boolean>(
                MethodConstants.isInteractiveInternal,
                displayId,
                uid
            )
        }
