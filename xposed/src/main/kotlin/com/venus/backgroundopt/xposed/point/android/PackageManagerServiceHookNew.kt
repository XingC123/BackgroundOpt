...
import com.venus.backgroundopt.xposed.entity.android.com.android.server.pm.PackageManagerService.PackageManagerServiceHelper
...
class PackageManagerServiceHookNew(
    ...
    override fun hook() {
        ClassConstants.PackageManagerService.afterConstructorHook(
            ...
            runningInfo.packageManagerService = PackageManagerServiceHelper.instanceCreator(
                param.thisObject
            )
        }
    }
